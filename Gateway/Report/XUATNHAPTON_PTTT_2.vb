...
Public Class XUATNHAPTON_PTTT_2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication8.XUATNHAPTON_PTTT_2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedXUATNHAPTON_PTTT_2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As XUATNHAPTON_PTTT_2 = New XUATNHAPTON_PTTT_2()
        rpt.Site = Me.Site
        Return rpt
    End Function
