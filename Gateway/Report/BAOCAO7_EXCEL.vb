...
Public Class BAOCAO7_EXCEL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication8.BAOCAO7_EXCEL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBAOCAO7_EXCEL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BAOCAO7_EXCEL = New BAOCAO7_EXCEL()
        rpt.Site = Me.Site
        Return rpt
    End Function
