...
Public Class BAOCAOTONGTOP_KHACHHANG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication8.BAOCAOTONGTOP_KHACHHANG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBAOCAOTONGTOP_KHACHHANG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BAOCAOTONGTOP_KHACHHANG = New BAOCAOTONGTOP_KHACHHANG()
        rpt.Site = Me.Site
        Return rpt
    End Function
