...
Public Class CR_TONGHOP_CONGNO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication8.CR_TONGHOP_CONGNO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MATK() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCR_TONGHOP_CONGNO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_TONGHOP_CONGNO = New CR_TONGHOP_CONGNO()
        rpt.Site = Me.Site
        Return rpt
    End Function
