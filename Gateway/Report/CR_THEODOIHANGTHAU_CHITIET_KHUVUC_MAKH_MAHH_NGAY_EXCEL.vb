...
Public Class CR_THEODOIHANGTHAU_CHITIET_KHUVUC_MAKH_MAHH_NGAY_EXCEL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CR_THEODOIHANGTHAU_CHITIET_KHUVUC_MAKH_MAHH_NGAY_EXCEL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication8.CR_THEODOIHANGTHAU_CHITIET_KHUVUC_MAKH_MAHH_NGAY_EXCEL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_mahd() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCR_THEODOIHANGTHAU_CHITIET_KHUVUC_MAKH_MAHH_NGAY_EXCEL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_THEODOIHANGTHAU_CHITIET_KHUVUC_MAKH_MAHH_NGAY_EXCEL = New CR_THEODOIHANGTHAU_CHITIET_KHUVUC_MAKH_MAHH_NGAY_EXCEL()
        rpt.Site = Me.Site
        Return rpt
    End Function
