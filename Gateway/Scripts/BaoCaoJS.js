...
$(document).ready(function () {
    ...
    //    }
    //});
    //$("#hangstada").click(function () {
    //    if ($("#hangstada").is(":checked")) {
    ...
    $("#donvi").change(function () {
        ...
        if ($("#chon").val() == 0) {
            ...
            $.post(lang + '/he-thong/GetBoLoc', { ChiNhanhId: Id },
                function (data) {
                    ...
                    for (var i = 0; i < data.HD.length; i++) {
                        $("#HopDongList").append('<div id="G' + data.HD[i].MAHD + data.HD[i].MAKH + '" class="checkbox checkbox-primary Checkboxlist12"><input class="Checkboxlist12" value="' + data.HD[i].MAHD + "~" + data.HD[i].MAKH + '" id="GG' + data.HD[i].MAHD + data.HD[i].MAKH + '" type="checkbox" name="Checkboxlist12"><label for="GG' + data.HD[i].MAHD + data.HD[i].MAKH + '">' + data.HD[i].MAHD + " &bull; " + data.HD[i].MAKH + " &bull; " + data.HD[i].DONVI + '</label></div>');
                    }
                    $("#Nhomcol").empty();
            ...
            $.post(lang + '/he-thong/PartialKhachHang', { ChiNhanhId: Id, phanloai: $("#Checkboxlist2").val() },
                function (data) {
