                            ...
                            action: function () {
                                ...
                                $("#tablehanghoa > tbody >tr.hanghoatr").each(function () {
                                    data1.push({
                                        ...
                                        , "GIABAN_VAT": Number($(this).closest('tr').find('td:eq(3)').text().replace(/[^\d.]/g, '').replace(".00", ""))
                                        , "VAT": $("#vat").val()
                                        , "GHICHU": "ETC - Mã hợp đồng : " + $("#hopdong").val() + " - " + $("#ghichu").val()
                                    });
                                    dem = dem + 1;
                                });
                                $.ajax({
                                            ...
                                            $.confirm({
                                                ...
                                                buttons: {
                                                    confirm: {
                                                        ...
                                                        keys: ['enter'],
                                                        action: function () {
                                                            window.location.href = "quan-ly-don-hang-ve-phong-kinh-doanh";
                                                        }
                                                    },
                                                    cancel: {
                                                        text: 'Hủy',
        ...
        $.confirm({
            ...
            buttons: {
                confirm: {
                    ...
                    keys: ['enter'],
                    action: function () {
                        window.location.href = "tao-don-dat-hang-ve-phong-kinh-doanh-mobile";
                    }
                },
                cancel: {
                    text: 'Hủy',
